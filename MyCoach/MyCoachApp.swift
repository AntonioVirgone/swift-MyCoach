...
let buttonColor1 = Color(#colorLiteral(red: 0.7490196078, green: 0.9176470588, blue: 0.7254901961, alpha: 1))
let buttonColor2 = Color(#colorLiteral(red: 0.9176470588, green: 0.5783282839, blue: 0.556867163, alpha: 1))
...
let BREACKFAST = "Colazione"
let LUNCH = "Pranzo"
let DINNER = "Cena"

let bgAppColor_: some View = ZStack {
    VStack(spacing: 0) {
